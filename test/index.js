...
function Main() {
    return (
//         <div>
//             <div style={{height:"200px", overflow: "auto", position: "absolute", left:"100px", top:"100px"}}>
//                 <pre ontouchmove={e => e.stopPropagation()}>
// {`hi
// hi
// hi
// hi
...
function Content() {
    return (
        <div style={{backgroundColor: "skyblue", display: "inline-block", width:"600px", padding:"40px"}}>
        <h1 style={{textAlign: "center", fontSize: "calc(max(13px, 80px - 2.5vw))"}}>동백꽃</h1>
            <pre style={{
                userSelect: "none",
                fontSize: "calc(max(13px, 60px - 5vw))",
                height:"700px",
